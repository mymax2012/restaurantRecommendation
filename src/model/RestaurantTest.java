...
public class RestaurantTest {
	...
	public void testStringToJSONArray(){
		...
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray(",Japanese")));
		
		jsonArray.put("");
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray(",Japanese,")));
		
		jsonArray.put("Chinese");
		assertTrue(jsonArrayStringEquals(jsonArray, Restaurant.stringToJSONArray(",Chinese,Japanese,")));
	}
	...
	public void testJsonArrayToString(){
		JSONArray jsonArray = new JSONArray();
		jsonArray.put("Japanese");
		jsonArray.put("United States");
		jsonArray.put("Italian");
		assertEquals("Japanese,United States,Italian", Restaurant.jsonArrayToString(jsonArray));
	}
